...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    // Fix recent searched cities logic
    setSearchedCities((prevSearched) => {
      const updatedSearchedCities = [...prevSearched, destination];
  ...
  return (
    ...
    >
      ...
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Unparalleled luxary and comfort await at the world's most exclusive hotels and resorts.Start Your journey today.
      </p>
