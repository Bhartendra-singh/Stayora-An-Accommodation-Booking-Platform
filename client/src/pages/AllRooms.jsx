...
const AllRooms = () => {
  ...
  const { rooms, navigate, currency, wishlist, toggleWishlist, user } = useAppContext();
  ...
  const roomTypes = ["Single Bed", "Double Room", "Luxury Room", "Family Suite"];
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row gap-10 pt-28 md:pt-36 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="w-full lg:w-2/3">
        ...
        {filteredRoom?.length === 0 ? (
          <div className="flex flex-col items-center text-center py-20 border border-dashed border-gray-300 rounded-xl">
            <p className="text-lg font-playfair text-gray-700 mb-2">No rooms found</p>
            <p className="text-sm text-gray-500 max-w-sm">
              We don't have any listings matching your search yet. Try a
              different destination, or browse all available rooms.
            </p>
          </div>
        ) : (
              ...
              <div className="md:w-1/2 flex flex-col gap-2 relative">
                {user && (
                  <button
                    ...
                    title={wishlist.includes(room._id) ? "Remove from wishlist" : "Save to wishlist"}
                  >
                    {wishlist.includes(room._id) ? "❤️" : "🤍"}
                  </button>
                )}
      ...
      {/* FILTERS SIDEBAR */}
      <div className="w-full lg:w-72 self-start border rounded-xl overflow-hidden">
        <div
        ...
        >
          ...
          <div className="px-5 pt-5 pb-6 pb-7">
